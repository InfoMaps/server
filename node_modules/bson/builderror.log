...
/home/raph/.node-gyp/4.2.6/include/node/node_buffer.h:31:40: note: candidate: v8::MaybeLocal<v8::Object> node::Buffer::New(v8::Isolate*, v8::Local<v8::String>, node::encoding) <near match>
 NODE_EXTERN v8::MaybeLocal<v8::Object> New(v8::Isolate* isolate,
                                        ^
/home/raph/.node-gyp/4.2.6/include/node/node_buffer.h:31:40: note:   conversion of argument 3 would be ill-formed:
In file included from ../ext/bson.h:17:0,
                 from ../ext/bson.cc:36:
../../nan/nan.h:672:67: error: invalid conversion from ‘uint32_t {aka unsigned int}’ to ‘node::encoding’ [-fpermissive]
     return node::Buffer::New(v8::Isolate::GetCurrent(), data, size);
                                                                   ^
In file included from ../ext/bson.cc:24:0:
/home/raph/.node-gyp/4.2.6/include/node/node_buffer.h:43:40: note: candidate: v8::MaybeLocal<v8::Object> node::Buffer::New(v8::Isolate*, char*, size_t) <near match>
 NODE_EXTERN v8::MaybeLocal<v8::Object> New(v8::Isolate* isolate,
                                        ^
/home/raph/.node-gyp/4.2.6/include/node/node_buffer.h:43:40: note:   conversion of argument 2 would be ill-formed:
In file included from ../ext/bson.h:17:0,
                 from ../ext/bson.cc:36:
...
/home/raph/.node-gyp/4.2.6/include/node/node.h:318:32: note: declared here
                 inline ssize_t DecodeBytes(
                                ^
/home/raph/.node-gyp/4.2.6/include/node/node.h:66:42: note: in definition of macro ‘NODE_DEPRECATED’
...
../ext/bson.cc:833:41: warning: ‘ssize_t node::DecodeWrite(char*, size_t, v8::Local<v8::Value>, node::encoding)’ is deprecated: Use DecodeWrite(isolate, ...) [-Wdeprecated-declarations]
   DecodeWrite(data, len, args[0], BINARY);
                                         ^
In file included from ../ext/bson.cc:22:0:
/home/raph/.node-gyp/4.2.6/include/node/node.h:331:32: note: declared here
...
../ext/bson.cc:928:73: warning: ‘v8::Local<v8::Value> node::Encode(const void*, size_t, node::encoding)’ is deprecated: Use Encode(isolate, ...) [-Wdeprecated-declarations]
   Local<Value> bin_value = Encode(serialized_object, object_size, BINARY)->ToString();
                                                                         ^
In file included from ../ext/bson.cc:22:0:
/home/raph/.node-gyp/4.2.6/include/node/node.h:299:45: note: declared here
...
gyp ERR! cwd /home/raph/WebstormProjects/infomaps/node_modules/bson
